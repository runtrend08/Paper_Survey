...
### 11 中科院Li，Xiang  “Let Model Keep Evolving”
 ...
 - **文章贡献**：**增量学习**。
 - **特征输入**：（1）文章提出了Multi-View，我理解是指代四类view，分别是包间时间间隔IAT、净荷序列、分组长度序列和内容类型序列。如Table 1。（）
 - **模型训练**：；
 - **数据集	**：在22类真实恶意流量数据集上。
 - **评估结果**：平均提高53.42%，14个月时间内容可以有效环节概念漂移问题。证明其有效性和泛化能力。
 - **文章总结**：
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjQ0MTk2ODEyLDExNjc1MTc4ODMsMjA5MT
A4OTUxMSwxNTQ5NDU0NTQzLDEwNDU2Mjc5MTksOTMwNzc2ODE5
XX0=
-->